...
| 初見問題モード | 共通テスト換算の推定点、分野別・難易度別の内訳、いちばん弱いユニット、文法／読解の選択 |
| 　文法 | ユニットを選ぶと、そのユニットの未解答問題だけを連続で出題。解答するとすぐに正しい根拠・誤った根拠の分析・和訳・解説が出ます |
...
保存する内容は問題ごとに、box・間違えた回数・次の出題日に加えて、**初見の正誤**と**難易度**です。
