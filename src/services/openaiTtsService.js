...
// ただしフラットな文字列しか受け取れず、Azure SSMLのようなセグメント単位の
// ピッチカーブ制御はできない。そのため、癖を精密に反映する必要がある実際の
// ミラー音声(source: "voice")には使わず、Model English / 模範日本語ミラー
// (癖を含まない模範発話)専用の経路とする。未設定・失敗時は呼び出し側で既存の
